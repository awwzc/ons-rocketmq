package com.jerry.mq.ons;


import com.jerry.mq.annotation.AsyncMQ;
import com.jerry.mq.core.ONSConsumer;
import com.jerry.mq.core.ONSMessageListener;
import com.jerry.mq.support.MethodIntrospector;
...
public class AsyncONSAnnotationBeanPostProcessor
    ...
    private String resolveTopic(String  topicExpr) {
        String topicPrefix = resolveExpression(AsyncONSBootstrapConfiguration.ONS_TOPIC_PREFIX_KEY);
        if(topicPrefix.equals(AsyncONSBootstrapConfiguration.ONS_TOPIC_PREFIX_KEY)){
            topicPrefix = "";
        }
