...
import com.jerry.mq.annotation.DelaySecond;
import com.jerry.mq.core.MQProducer;
import com.jerry.mq.core.RocketMQProducer;
import com.jerry.mq.annotation.ShardingKey;
    ...
    public Object invoke(Object proxy, Method method, Object[] paramObjects) throws Throwable {
        try{
            ...
            String prefixKey = producer instanceof RocketMQProducer ?
                    AsyncMQBootstrapConfiguration.ROCKETMQ_TOPIC_PREFIX_KEY : AsyncONSBootstrapConfiguration.ONS_TOPIC_PREFIX_KEY;
